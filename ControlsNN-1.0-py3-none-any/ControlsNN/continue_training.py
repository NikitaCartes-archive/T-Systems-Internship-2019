...
def continue_training(dataset_path, epoch, bs):
	...
	model.save(os.path.dirname(os.path.abspath(inspect.stack()[0][1]))+ "/vggnet.model")
	f = open(os.path.abspath(os.path.dirname(os.path.abspath(inspect.stack()[0][1])) +"/vggnet_lb.pickle"), "wb")
